...
import { Search, Calendar, MessageSquare, Loader2, Eye, CheckCircle2, XCircle, Clock, AlertCircle } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage and respond to business enquiries</p>
        </div>
      </div>
      ...
      <div className="bg-white p-4 rounded-lg border space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <Input
            ...
            onChange={(e) => handleDateRange(e.target.value || undefined, filters.endDate)}
            className="w-full"
          />
          ...
          <Input
            ...
            onChange={(e) => handleDateRange(filters.startDate, e.target.value || undefined)}
            className="w-full"
          />
        </div>
      </div>
      ...
      <Dialog open={updateDialogOpen} onOpenChange={setUpdateDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Update the status and add a response to this enquiry
            </DialogDescription>
          </DialogHeader>
          {selectedEnquiry && (
            <div className="space-y-4">
              ...
              <div>
                ...
                <Textarea
                  ...
                  placeholder="Add a response to the enquiry..."
                  rows={5}
                />
              </div>
              <div className="flex justify-end gap-2 pt-4">
